      ...
      if (this.paymentAddForm.valid){
        this.rentService.add(this.rentService.getRentalInfo()).subscribe((response) => {
          ...
          this.customerService.addScore(this.customer2).subscribe((response2) => {
            this.toastrService.success("Congratulations! You have won 100 findex points.");
    ...
    if(this.customer2?.findexPoint >= parseInt(this.localStorageService.getItem("MFP")!)){
      if (this.paymentAddForm.valid) {
        ...
        this.creditCardService.add(cardModel).subscribe(
          (response) => {
            this.rentService.add(this.rentService.getRentalInfo()).subscribe((response2) => {
              ...
              this.toastrService.error(ErrorHelper.getMessage(responseError2), "Error");
            });
          },
          (responseError) => {
